    ...
    <div style={{ marginTop: "20px" }}>
      <Grid>
        <Grid.Cell columnSpan={{ xs: 6, sm: 3, md: 3, lg: 6, xl: 6 }}>
          <LegacyCard title="What to do next" sectioned>
            <p className="mt-2 mb-2">If you don’t have a product catalog, you have to create one:</p>
        ...
        <Grid.Cell columnSpan={{ xs: 6, sm: 3, md: 3, lg: 6, xl: 6 }}>
          <LegacyCard title="Happy with the app?" sectioned>  
            <Image
              source={logo}
              alt="Local logo"
              style={{ maxWidth: "100%" }}
            ...
            <Button size="large" variant="primary" tone="success">Leave A Review
            </Button>
          </LegacyCard>
        </Grid.Cell>
      </Grid>
